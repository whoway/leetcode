...
| ⭐️[41. 缺失的第一个正数](https://leetcode-cn.com/problems/first-missing-positive/) |       |       |         |
...
| 题号                                                         | C++11 | 状态 |
| ------------------------------------------------------------ | ----- | ---- |
| 💦[387. 字符串中的第一个唯一字符](https://leetcode-cn.com/problems/first-unique-character-in-a-string/) | 1     |      |
| 💦[389. 找不同](https://leetcode-cn.com/problems/find-the-difference/) | 1     |      |
| 💦[383. 赎金信](https://leetcode-cn.com/problems/ransom-note/) | 1     |      |
...
| 题号                                                         | C++11 | 状态 |
| ------------------------------------------------------------ | ----- | ---- |
| Ⓜ️[66. 加一](https://leetcode-cn.com/problems/plus-one/)      | 1     |      |
| Ⓜ️[67. 二进制求和](https://leetcode-cn.com/problems/add-binary/) | 1     |      |
| Ⓜ️[415. 字符串相加](https://leetcode-cn.com/problems/add-strings/) | 1     |      |
